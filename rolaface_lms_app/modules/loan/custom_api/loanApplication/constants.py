ALLOWED_CUSTOM_LOAN_APPLICATION_FIELDS = {
    ...
    "phone", "email", "national_registration_card",
    "gender", "marital_status", "birth_date",

    # Personal Loan - Residence & Employment
    "residential_address", "occupation", "employer_name",
    "nationality", "loan_purpose",
...
RETURN_FIELDS_GET_BY_ID = list(ALLOWED_CUSTOM_LOAN_APPLICATION_FIELDS) + [
    "name", "creation", "modified", "docstatus", "naming_series"
]

ALLOWED_SORT_FIELDS = {
    "name", "creation", "modified", "application_date",
    "application_type", "status", "customer"
}
